  ...
  return (
    <form action={formAction} className="space-y-3">
      ...
      <div>
        ...
        <select name="toUserId" required defaultValue="" className="w-full rounded-lg border border-zinc-300 px-3 py-1.5 text-sm">
      ...
      <div>
        ...
        <input name="subject" required className="w-full rounded-lg border border-zinc-300 px-3 py-1.5 text-sm" />
      </div>
      <div>
        <label className="mb-1 block text-xs text-zinc-500">Message</label>
        <textarea name="body" required rows={3} className="w-full rounded-lg border border-zinc-300 px-3 py-1.5 text-sm" />
      </div>
