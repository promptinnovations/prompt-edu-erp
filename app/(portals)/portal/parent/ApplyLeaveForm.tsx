    ...
    <div className="rounded-2xl border border-zinc-200 bg-white p-6">
      ...
      <form action={formAction} className="flex flex-wrap items-end gap-2">
        ...
        <div>
          ...
          <input type="date" name="startDate" required className="rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400" />
        </div>
        <div>
          <label className="mb-1 block text-xs text-zinc-500">To</label>
          <input type="date" name="endDate" required className="rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400" />
        </div>
        <div className="flex-1 min-w-[10rem]">
          <label className="mb-1 block text-xs text-zinc-500">Reason</label>
          <input name="reason" className="w-full rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400" />
        </div>
