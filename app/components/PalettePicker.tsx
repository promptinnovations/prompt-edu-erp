    ...
    <form action={formAction} className="space-y-4">
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {allowPlatformDefault ? (
          ...
          >
            <span className="flex h-9 w-full items-center justify-center rounded-lg border border-dashed border-[var(--border-subtle)] text-[10px] uppercase tracking-[0.08em] text-zinc-500">
              Auto
            </span>
