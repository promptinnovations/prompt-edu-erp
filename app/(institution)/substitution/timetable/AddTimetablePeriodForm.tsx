  ...
  return (
    <form action={formAction} className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-6">
      <div>
        ...
        <select name="classId" value={classId} onChange={(e) => setClassId(e.target.value)} required className="w-full rounded-lg border px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--brand)] focus:border-[var(--brand)]">
      ...
      <div>
        ...
        <select name="sectionId" required defaultValue="" className="w-full rounded-full border px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--brand)] focus:border-[var(--brand)]">
          <option value="">Select…</option>
      ...
      <div>
        ...
        <select name="dayOfWeek" required defaultValue="" className="w-full rounded-full border px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--brand)] focus:border-[var(--brand)]">
          <option value="">Select…</option>
      ...
      <div>
        ...
        <select name="subjectId" defaultValue="" className="w-full rounded-full border px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--brand)] focus:border-[var(--brand)]">
          <option value="">—</option>
      ...
      <div>
        ...
        <select name="teacherStaffId" defaultValue="" className="w-full rounded-full border px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--brand)] focus:border-[var(--brand)]">
