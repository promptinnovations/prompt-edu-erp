      ...
      <tbody className="divide-y divide-zinc-100 dark:divide-zinc-800">
        {submissions.map((s) => (
          <tr key={s.id}>
            ...
            <td className="py-1.5">
              {s.evidence_file_id ? (
                <a href={`/api/files/${s.evidence_file_id}`} target="_blank" rel="noreferrer" className="text-zinc-600 dark:text-zinc-400 underline hover:text-zinc-900 dark:hover:text-white">
                  View
                </a>
              ) : (
