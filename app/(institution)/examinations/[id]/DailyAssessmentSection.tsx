          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y">
                {consolidated.map((r) => (
                  <tr key={r.student_id}>
                    <td className="py-1.5 pr-4 text-zinc-900">{r.student_name}</td>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y">
              {classAnalysis.map((c) => (
                <tr key={c.class_id}>
                  <td className="py-1.5 pr-4 text-zinc-900">{c.class_name}</td>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y">
                {studentAnalysis.map((s) => (
                  <tr key={s.student_id}>
                    <td className="py-1.5 pr-4 text-zinc-900">{s.student_name}</td>
