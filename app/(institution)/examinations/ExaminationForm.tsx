  ...
  return (
    <form action={formAction} className="flex flex-wrap items-end gap-2">
      <div>
        ...
        <select name="examTypeId" required className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm">
          {examTypes.map((t) => (
      ...
      <div>
        ...
        <select name="academicYearId" required defaultValue={academicYears.find((y) => y.is_current)?.id} className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm">
          {academicYears.map((y) => (
      ...
      <div>
        ...
        <input name="name" required placeholder="e.g. Term 1 Academic Main Exam" className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
      </div>
