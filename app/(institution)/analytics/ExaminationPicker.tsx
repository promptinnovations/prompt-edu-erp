  ...
  return (
    <form method="get" className="flex items-end gap-2">
      ...
      <div>
        ...
        <select name="examinationId" defaultValue={examinationId} className="rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400">
