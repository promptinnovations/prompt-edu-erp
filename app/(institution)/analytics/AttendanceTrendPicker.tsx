  ...
  return (
    <form method="get" className="flex flex-wrap items-end gap-2">
      ...
      <div>
        ...
        <select name="trendClassId" defaultValue={classId} className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm">
      ...
      <div>
        ...
        <select name="trendSectionId" defaultValue={sectionId} className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm">
          <option value="">Select…</option>
      ...
      <div>
        ...
        <input type="month" name="fromMonth" defaultValue={fromMonth} className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
      </div>
      <div>
        <label className="mb-1 block text-xs text-zinc-500 dark:text-zinc-400">To month</label>
        <input type="month" name="toMonth" defaultValue={toMonth} className="rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
      </div>
