      ...
      <div className="flex items-center gap-4">
        ...
        <form action={uploadAction} className="flex flex-1 flex-wrap items-center gap-2">
          <input
            ...
            required
            className="max-w-full text-sm text-zinc-600 file:mr-3 file:rounded-lg file:border-0 file:bg-[var(--accent-teal)] file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-white hover:file:opacity-90"
          />
          <button
            type="submit"
