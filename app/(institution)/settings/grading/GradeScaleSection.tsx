  ...
  return (
    <li className="flex items-center justify-between gap-2 py-1 text-sm">
      <span className="flex items-center gap-2">
        ...
        {band.grade_point ? <span className="text-zinc-400"> · GP {band.grade_point}</span> : null}
      </span>
      {canManage ? (
        <span className="flex items-center gap-2">
  ...
  return (
    <div className="rounded-xl border border-zinc-200 p-4">
      ...
      <ul className="divide-y divide-zinc-100">
        {bands.length === 0 ? <li className="py-1 text-xs text-zinc-400">No grade bands yet.</li> : null}
...
export default function GradeScaleSection({
  ...
  return (
    <div className="space-y-4">
      {gradeScales.length === 0 ? <p className="text-sm text-zinc-400">No grade scales yet.</p> : null}
      {gradeScales.map((s) => (
