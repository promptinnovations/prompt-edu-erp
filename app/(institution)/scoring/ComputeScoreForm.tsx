  ...
  return (
    <form action={formAction} className="flex flex-wrap items-end gap-2">
      ...
      <div>
        ...
        <input name="period" required defaultValue={`${currentYear} Consolidated`} className="rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400" />
      </div>
      <div>
        <label className="mb-1 block text-xs text-zinc-500">From date</label>
        <input type="date" name="fromDate" required defaultValue={`${currentYear}-01-01`} className="rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400" />
      </div>
      <div>
        <label className="mb-1 block text-xs text-zinc-500">To date</label>
        <input type="date" name="toDate" required defaultValue={`${currentYear}-12-31`} className="rounded-lg border border-zinc-300 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-400 focus:border-indigo-400" />
      </div>
