  ...
  return (
    <form action={formAction} className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-end sm:gap-2">
      <div className="w-full sm:w-40">
        ...
        <input name="code" required placeholder="e.g. green-valley" className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
      </div>
      <div className="w-full sm:w-56">
        <label className="mb-1 block text-xs text-zinc-500 dark:text-zinc-400">Name</label>
        <input name="name" required className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
      </div>
      <div className="w-full sm:w-auto">
        <label className="mb-1 block text-xs text-zinc-500 dark:text-zinc-400">Type</label>
        <select name="type" className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm sm:w-auto">
      ...
      <div className="w-full sm:w-auto">
        ...
        <select name="defaultLocale" className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm sm:w-auto">
      ...
      <div className="w-full border-t border-zinc-100 dark:border-zinc-800 pt-3 sm:basis-full">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          <div className="w-full sm:w-48">
            ...
            <input name="adminEmail" type="email" placeholder="admin@example.com" className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
          </div>
          <div className="w-full sm:w-48">
            <label className="mb-1 block text-xs text-zinc-500 dark:text-zinc-400">Admin full name</label>
            <input name="adminFullName" className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
          </div>
          <div className="w-full sm:w-40">
            <label className="mb-1 block text-xs text-zinc-500 dark:text-zinc-400">Admin password</label>
            <input name="adminPassword" type="password" minLength={8} placeholder="8+ characters" className="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-1.5 text-sm" />
          </div>
        </div>
      </div>
      ...
      <button
        type="submit"
        disabled={pending}
        className="w-full rounded-md bg-zinc-900 px-3 py-1.5 text-sm text-white hover:bg-zinc-800 disabled:opacity-50 sm:w-auto"
      >
        Create institution
      </button>
